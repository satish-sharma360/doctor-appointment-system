    ...
    return userData ? (
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            {isEdit
                ? <label htmlFor='image' >
                    <div className='inline-block relative cursor-pointer'>
                        <img className='w-36 bg-[#00ff264c] rounded opacity-75' src={image ? URL.createObjectURL(image) : userData.image} alt="" />
                        <img className='w-10 bg-[#09ff00] absolute bottom-12 right-12' src={image ? '' : assets.upload_icon} alt="" />
                    </div>
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-[#363636]'>
                    ...
                    {isEdit
                        ...
                        : <p className='text-[#22C55E]'>{userData.phone}</p>
                    }
            ...
            <div className='mt-10'>
                ...
                {isEdit
                    ? <button onClick={updateUserProfileData} className='border border-[#22C55E] px-8 py-2 rounded-full hover:bg-[#22C55E] hover:text-white transition-all'>Save information</button>
                    : <button onClick={() => setIsEdit(true)} className='border border-[#22C55E] px-8 py-2 rounded-full hover:bg-[#22C55E] hover:text-white transition-all'>Edit</button>
                }
